...
ромб в дереве наследования, как видно на диаграмме `Platypus`.
...
Например, для класса `Platypus`, MRO будет `[Mammal, Bird, Vertebrate]`.
...
`[Mammal, Vertebrate, Bird]` - если бы он не нашел метод в `Mammal`, далее стал 
