...
сервер python, чтобы написать эмулятор, мы обнаружили, что в этом сервере вообще нет работы с XML.
...
Swagger настолько крив, что с удовольствием взяли бы что-то иное, но вот что?
